package org.munozy.medialibrary.mlbookservice.util;
...
public class LiquibaseUtil {
    ...
    private static final String DB_CHANGELOG = "db/changelog/db.changelog-test.xml";
     ...
     */
    public LiquibaseUtil(final DataSource dataSource) {
     ...
     */
    public LiquibaseUtil checkAndFail() {

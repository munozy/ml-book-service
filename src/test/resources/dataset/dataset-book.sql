...
insert into ml_book_service.book (id, title, author) values (1001, 'Planetary 4', 'Warren Ellis');
insert into ml_book_service.book (id, title, author) values (1002, 'Planetary 5', 'Warren Ellis');